---
name: windows-memory-manipulation
description: Windows process memory scanning and manipulation using PyMem library. Covers pattern scanning, read/write operations, and privilege management.
license: MIT
metadata:
